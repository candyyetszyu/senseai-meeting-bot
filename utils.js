...
function extractMeetingId(text) {
  // Try to extract ID from text (e.g., "meeting_123", "123", etc.)
...
function isValidTranscript(transcript) {
  ...
  // Require at least 50 characters for a valid transcript
...
function extractMeetingTitle(transcript) {
  ...
  // If first line looks like a title (short and not dialogue)
  ...
  // Default: use truncated first line
